...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2024 a las 23:48:39
...
CREATE TABLE `acta` (
  ...
  `tipo_acta` int(11) DEFAULT NULL COMMENT '1 es Acta de entrega\r\n2 es acta de descargo',
  `cua_id` int(11) DEFAULT NULL
...
INSERT INTO `acta` (`id_acta`, `tipo_acta`, `cua_id`) VALUES
(28, 1, 1),
(29, 2, 3),
(30, 1, 1),
(31, 1, 4);
...
(190, 'ABAD PALACIOS BYRON MOISES', '0961978087', 1),
(191, 'SANTILLAN ALCIVAR VICTOR STALIN', '0953511169', 1);
...
(1, 'CPU Idepad2010', 'Lenovo', '13YH68485'),
...
--
ALTER TABLE `acta`
  MODIFY `id_acta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `tm_cuadrilla`
  MODIFY `cua_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
...
--
ALTER TABLE `acta`
  ADD CONSTRAINT `acta_ibfk_1` FOREIGN KEY (`cua_id`) REFERENCES `tm_cuadrilla` (`cua_id`);
