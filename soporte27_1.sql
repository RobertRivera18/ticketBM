...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-01-2025 a las 22:52:07
...
(276, 'Chip Claro', 'CLARO', 'CLARO PREPAGO', '0939323518', 0),
...
(307, 'Chip Claro', 'Claro Prepago', 'CLARO PREPAGO', '0985510720', 0),
(308, 'Chip Claro', 'Claro Prepago', 'CLARO PREPAGO', '0993565425', 0),
(310, 'TABLET TAB8', 'SAMSUNG', 'TAB8', 'R9JT10GNEKP', 0),
(311, 'Chip Claro', 'Claro', 'CLARO PREPAGO', '0993556063', 0),
(312, 'Laptop', 'Dell', 'Latitude 5480', 'D29Q1N2', 0),
(314, 'Chip Claro', 'CLARO', 'CLARO PREPAGO', '0939323518', 1),
(315, 'Chip Claro', 'CLARO', 'CLARO PREPAGO', '0980709741', 1),
(316, 'Chip Claro', 'CLARO', 'CLARO PREPAGO', '0980002949', 1),
(317, 'Chip Claro', 'CLARO', 'CLARO PREPAGO', '0959078089', 1),
(319, 'Chip Claro', 'CLARO', 'CLARO PREPAGO', '0980766608', 1);
...
INSERT INTO `tm_inspeccion` (`inspeccion_id`, `trabajo`, `ubicacion`, `numero_orden`, `fecha`, `solicitante_id`) VALUES
(34, 1, 'Samanes ', '0003', '2025-01-27 21:17:10', 2),
(35, 2, 'Florida Norte Diagonal al CNT', '0003', '2025-01-27 21:43:14', 102),
(36, 1, 'Parque SAMANES ', '00089', '2025-01-27 21:47:05', 106),
(37, 1, 'Parque SAMANES ', '00089', '2025-01-27 21:47:08', 106);
...
--
ALTER TABLE `acta`
  MODIFY `id_acta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
...
--
ALTER TABLE `td_ticketdetalle`
  MODIFY `tickd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `tm_colaborador`
  MODIFY `col_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;

--
-- AUTO_INCREMENT de la tabla `tm_cuadrilla`
--
ALTER TABLE `tm_cuadrilla`
  MODIFY `cua_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=141;
...
--
ALTER TABLE `tm_equipos`
  MODIFY `equipo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=320;

--
-- AUTO_INCREMENT de la tabla `tm_inspeccion`
--
ALTER TABLE `tm_inspeccion`
  MODIFY `inspeccion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
