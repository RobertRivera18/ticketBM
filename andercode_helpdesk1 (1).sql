...
(1, 'Cinthya Hermenejildo Acosta', '0928411990', 2),
...
(45, 'gpon30'),
(47, 'CuadrillaCNEL001'),
(48, 'CuadrillaCNEL00178'),
(50, 'CuadrillaCNEL0009');
...
--
ALTER TABLE `tm_colaborador`
  MODIFY `col_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=189;

--
-- AUTO_INCREMENT de la tabla `tm_cuadrilla`
--
ALTER TABLE `tm_cuadrilla`
  MODIFY `cua_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
