...
//                         '<i class="fa fa-times text-danger ms-2 mt-1" style="cursor: pointer;" onClick="eliminarItem(' . (int)$row["cua_id"] . ', ' . $col_id . ')"></i>' .
//                         '</li>';
//                 }, $colaboradores);
...
//             }
    ...
    case "eliminar_colaborador":
        ...
        if ($cuadrilla->delete_cuadrilla_colaborador($cua_id, $col_id)) {
